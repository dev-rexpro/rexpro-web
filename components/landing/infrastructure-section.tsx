        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              Modernize once, scale everywhere. Our high-resiliency hybrid infrastructure spans 17 sovereign data centers across 6 continents, ensuring sub-50ms latency for critical enterprise workloads.
            </p>
